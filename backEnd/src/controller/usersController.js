...
async function arquivos() {
  const userFetch = await fetch('https://drive.google.com/file/d/1CdhQ5kRBI3Tul1Qxjo4q6coIVrKFrw3c');
  const users = await userFetch.json();
}
// const users = require('https://github.com/tcbandolilegg/API_ReceitasDeFamilia/blob/main/src/modal/dataUsers.json')
const fs = require('fs')
